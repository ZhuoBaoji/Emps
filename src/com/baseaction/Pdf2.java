...
public class Pdf2<T> {
   ...
   public static void main(String[] args) {
	   ...
	   Pdf2<Student> ex = new Pdf2<Student>();
	      ...
	      String[] headers = { "id", "name", "age", "性别", "出生日期" };
...
//	   Integer id, String name, int age, Double salary
	   	      dataset.add(new Emp(10000001, "张三",34, 20.3));
	   	      dataset.add(new Emp(10000002, "张4",32, 20.3));
	   	      dataset.add(new Emp(10000003, "张5",34, 20.3));
